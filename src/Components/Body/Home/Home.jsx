  ...
  return (
    <div className="homeMain">
      ...
      <div className="homeContent">
        ...
        <p>I'm a MERN web and product developer with a strong focus on creativity, problem-solving, and logical thinking. With experience in complex websites, robotics, and drone development, I've built innovative solutions, including a web platform for remote drone control using React and Node.js. I excel at leveraging AI tools and have led successful projects in both software and hardware domains.</p>
